...
**Curiosity-driven builder exploring how AI can help people do meaningful work**
...
- How AI can help experts do their work better (not replace them)
- Building systems that people actually enjoy using
- Finding the balance between what's possible and what's practical
- Creating tools that respect human expertise while amplifying it
...
So I built JTES — an AI assistant that:
- Finds relevant tax information and always shows where it came from
- Uses the way tax professionals actually think about problems (not just keyword matching)
- Explains things clearly while staying accurate

**What I learned:** The best AI systems aren't about showing off how smart the model is — they're about understanding what the person using it actually needs to be successful.
...
**What I learned:** Sometimes the smartest solution is the simplest one. You don't always need the newest tech — you just need to solve the right problem.
...
### Infrastructure Transformation at Scale (AXA / Smart Partners)
**Coordinating work across continents**

I've led infrastructure refresh programs that touched thousands of devices and hundreds of servers across Japan, Europe, and North America. After a major merger, I helped standardize systems and implement disaster recovery plans that would protect the business if something went wrong.

**What I'm proud of:** Getting people in different time zones, with different priorities, to all row in the same direction. That's not technical work — that's people work.

---

### Change Leadership & Enablement
**Helping organizations through transformation**

One thing I've learned over and over: the technology is usually the easy part. The hard part is helping people understand why change matters, what's in it for them, and how they'll succeed in the new way of doing things.

I've created governance frameworks, led steering committees, managed stakeholders, and built communication plans — not because I love process, but because it helps real people do real work.

**What I'm proud of:** When someone tells me "I actually get it now" or "I can do my job better because of this."

---

## What I Bring to a Team

**Learning mindset:** I'm not afraid to say "I don't know, let's figure it out." I've learned more from problems that stumped me than from things that were easy.

**Respect for expertise:** I don't believe AI replaces humans — I believe it helps experts do what they do best. I've worked with tax pros, engineers, analysts, and executives, and I always start by listening to what they actually need.
...
I'm open to full-time roles, consulting, or advisory work. What matters most to me:

1. **Meaningful problems:** I want to work on things that actually matter to someone, not just more features nobody needs.

2. **Room to learn:** If I'm not learning something new, I'm probably not growing. I want to work with people who challenge me.

3. **Respect for craft:** Teams that care about quality, not just shipping. That means thinking about the user, the maintainers, and the long-term impact.

4. **Autonomy with accountability:** I want the freedom to figure things out, but I also believe in owning the outcome.

---

## Get in Touch

I'm always curious to learn about interesting problems and interesting people. If you're working on something that matters, I'd love to hear about it.

- **Portfolio:** https://kinokoholic.com
- **JD Analyzer:** https://kinokoholic.com (test your job descriptions against my experience)
